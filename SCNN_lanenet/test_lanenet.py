...
if __name__ == '__main__':
    # init args
    image_path = 'image_list.txt'
    weights_path = 'model_culane-71-3/culane_lanenet_vgg_2018-12-01-14-38-37.ckpt-10000'
    use_gpu = True
    batch_size = 8
    ...
    test_lanenet(image_path, weights_path, use_gpu, img_name, batch_size, save_dir)