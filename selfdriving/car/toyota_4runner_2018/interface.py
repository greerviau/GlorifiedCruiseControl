...
class Interface(object):
    ...
    def get_can_messages(self):
        ...
        sas_angle = parse_sas_angle_codes(sas_angle_hex_codes)
        accel_pos = parse_accel_codes(accel_hex_codes)
        brake_pos = parse_brake_codes(brake_hex_codes)
        speed = parse_speed_codes(speed_hex_codes)
